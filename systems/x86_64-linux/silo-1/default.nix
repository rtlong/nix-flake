...
}:
{
  ...
  config = {
    ...
    ## Networking
    networking.hostName = "silo-1"; # Define your hostname.
    networking.hostId = "e3e5cefd"; # provide a unique 32-bit ID, primarily for use by ZFS. This one was derived from /etc/machine-id
